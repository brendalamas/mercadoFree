...
<body>
    <header>
        <nav class="navbar navbar-expand-lg">
            <div class="container p-4"><a href="#" class="navbar-brand fw-bold"><img src="./img2/mercadofree-logo.png" alt="logo"> Mercado Free</a><button type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="true" aria-label="Toggle navigation" class="navbar-toggler"><span class="navbar-toggler-icon"></span></button>
                <div id="navbarSupportedContent" class=" navbar-collapse collapse" style="">
                    ...
                    <li class="d-flex2"><?= $_SESSION['nombre'] ?>
                        <i class="fa fa-user-circle ml-3" style="size: 24px;"></i>
                    </li>
                </div>
            </div>
        </nav>
